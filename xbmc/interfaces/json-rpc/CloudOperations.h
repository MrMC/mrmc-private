...
namespace JSONRPC
{
  ...
  public:
    ...
    static JSONRPC_STATUS DropBoxAuthorize(const std::string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result);
  };
}
