...
class  CCodecAVPlayerHLSTransMuxer;

class CDVDVideoCodecAVPlayer : public CDVDVideoCodec, CThread
{
public:
  CDVDVideoCodecAVPlayer();
  virtual ~CDVDVideoCodecAVPlayer();
...
protected:
  ...
  CCodecAVPlayerHLSTransMuxer *m_muxer;
