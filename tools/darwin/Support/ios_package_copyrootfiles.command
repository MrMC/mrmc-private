...
if [ "$ACTION" == build ] || [ "$ACTION" == install ]; then
  ...
  DEFAULTSKIN_EXCLUDES="--exclude addons/skin.mrmc --exclude addons/skin.re-touched --exclude addons/skin.amber --exclude addons/skin.pm3.hd --exclude addons/skin.sio2 --exclude addons/skin.red"
  ...
  # and RED skin
  package_skin "${SYNC}" "$SRCROOT/addons/skin.red"
