...
if [ "$ACTION" == build ] || [ "$ACTION" == install ]; then
  ...
  if [ -f "$SRCROOT/addons/skin.red/addon.xml" ]; then
    ...
    ${SYNCSKIN_C} "$SRCROOT/addons/skin.red"    "$TARGET_BUILD_DIR/$TARGET_NAME/AppData/AppHome/addons"
    ${SYNC} "$SRCROOT/addons/skin.red/backgrounds" "$TARGET_BUILD_DIR/$TARGET_NAME/AppData/AppHome/addons/skin.red"
    ${SYNC} "$SRCROOT/addons/skin.red/icon.png" "$TARGET_BUILD_DIR/$TARGET_NAME/AppData/AppHome/addons/skin.red"
  fi
